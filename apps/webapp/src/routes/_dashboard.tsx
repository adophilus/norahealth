	...
	return (
        ...
        <div className="flex h-screen bg-background flex-col md:flex-row">
            ...
            <div className="md:hidden flex items-center justify-between bg-card border-b border-border p-4">
				...
				>
					{sidebarOpen ? (
						<X className="w-5 h-5 text-foreground bg-primary" />
					) : (
            ...
            {/* Sidebar */}
            <div
				className={`${sidebarOpen ? "fixed inset-0 z-40 md:static" : "hidden md:flex"
					} md:flex`}
			>
				<Sidebar />
			</div>
            ...
            {/* Main Content */}
            <main className="flex-1 overflow-hidden bg-backgroundxcv">
